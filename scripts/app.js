...
window.onload = () => {
    ...
    let url = 'https://api.themoviedb.org/3/movie/373571?api_key=84eed6c7b5d95107ef16601d73120558';
    ...
    .then(data => {
        ...
        moviePoster.src = `https://www.themoviedb.org/t/p/w600_and_h900_bestv2${data.poster_path}`;
